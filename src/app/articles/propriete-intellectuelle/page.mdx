...
export const article = {
  ...
  description: 'Comment les algorithmes de machine learning redéfinissent-ils la propriété intellectuelle ? Entre brevets, secrets industriels et questions d\'attribution, une exploration des enjeux légaux et éthiques de l\'IA.',
  lang: 'Français',
