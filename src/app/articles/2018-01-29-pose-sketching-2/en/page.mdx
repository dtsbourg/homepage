...
<Image src={pinholeModel} alt="Pinhole camera model diagram with focal point and projection plane" />
...
<Image src={pixelControl} alt="Diagram showing robot arm control mapping from pixel space to joint angles" />
...
<Image src={calibrationStep} alt="Calibration step screenshot showing Baxter robot arm positioning for camera alignment" />
...
<Image src={controlPixel} alt="Screenshot demonstrating robot control through single pixel click on mobile interface" />
