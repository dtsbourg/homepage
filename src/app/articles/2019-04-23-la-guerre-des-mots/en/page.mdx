...
export const article = {
  ...
  description: 'When OpenAI refused to publish GPT-2 for fear of its malicious use: an analysis of the challenges of automatic text processing, between linguistic regularities and scientific responsibility.',
  lang: 'English',
...
> Published on the blog _Artifices Intelligents_ of Le Temps newspaper. Available [here](https://blogs.letemps.ch/dylan-bourgeois/2019/04/23/la-guerre-des-mots-comment-les-machines-traitent-le-texte/).
...
<Image src={zipfWiki} alt="Graph demonstrating Zipf's law showing inverse relationship between word frequency and rank in Wikipedia text" />
...
<Image src={promptExample} alt="Example of GPT-2 text generation showing prompt input and AI-generated output text" />
