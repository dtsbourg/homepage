...
export const article = {
  ...
  description: 'Le Portrait d\'Edmond Bellamy vendu chez Christie\'s pour 480\'000 CHF : une exploration des GANs, de l\'art génératif et des questions fondamentales sur qui est vraiment l\'artiste quand une machine crée.',
  lang: 'Français',
...
<Image src={edmondBellamy} alt="Le portrait d'Edmond Bellamy, œuvre d'art générée par IA créée par GAN et vendue chez Christie's" />
...
<Image src={ganProgress} alt="Chronologie montrant l'amélioration progressive des images générées par GAN de 2014 à aujourd'hui" />
...
<Image src={interpolationDog} alt="Visualisation d'interpolation BigGAN transformant progressivement un chien en méduse" />
...
<Image src={ganMath} alt="Formule mathématique représentant l'architecture GAN utilisée comme signature du portrait d'Edmond Bellamy" />
...
<Image src={tomwhite} alt="Œuvre d'art générative abstraite de Tom White utilisant la perception des réseaux neuronaux" />
